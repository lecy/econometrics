...
```{r diffindiff, fig.cap="Figure 1. Difference in difference model", echo=F }
T1 <- 50
T2 <- 85
CF <- 75
C1 <- 35
...
```{r didtable, fig.cap="Figure 2. Difference in difference, an example", out.width='60%', echo=F }
...
```{r dataset, fig.cap="Figure 3. Diff-in-Diff dataset", out.width='60%', echo=F }
...
```{r beta0, fig.cap="Figure 4. Difference in difference, beta 0", echo=F }
...
```{r beta1, fig.cap="Figure 5. Difference in difference, beta 1", echo=F }
...
```{r beta2, fig.cap="Figure 6. Difference in difference, beta 2", echo=F }
...
```{r beta3, fig.cap="Figure 7. Diff-in-Diff, beta 3", echo=F }
...
```{r counterfactual, fig.cap="Figure 8. DID counterfactual", echo=F }
...
```{r CF, fig.cap="Figure 9. Counterfactual, betas", echo=F }
...
```{r housing, fig.cap="Figure 10. A housing project in [New York](https://www1.nyc.gov/site/nycha/about/100-percent-affordable-housing.page)", out.width='60%', echo=F }
...
```{r Example, fig.cap="Figure 11. Results from the working example", echo=F }
...
```{r repstudy, fig.cap="Figure 12. Source: http://factsmaps.com/minimum-wage-us-states-july-2018/", out.width='60%', echo=F }
...
```{r cases, fig.cap="Figure 13. Multiple cases in a DID model", echo=F }
...
```{r pline, fig.cap="Figure 14. Parallel trend assumption: met", echo=F }
...
```{r pline2, fig.cap="Figure 15. Parallel trend assumption: counterfactual", echo=F }
...
```{r pline3, fig.cap="Figure 16. Parallel trend assumption: unmet", echo=F }
## Case 3
...
```{r pline4, fig.cap="Figure 17. Parallel trend assumption: wrong counterfactual", echo=F }
