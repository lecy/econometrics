...
```{r figure1, fig.cap="Figure 1. Covariance structure of an omitted variable model", out.width='40%', echo=F }
...
```{r figure2, fig.cap="Figure 2. Covariance structure and residuals", out.width='80%', echo=F }
...
```{r figure3, fig.cap="Figure 3. Instrumental variable modeal, covariance structure", out.width='40%', echo=F }
...
```{r figure4, fig.cap="Figure 4. Path diagram of the instrumental variable model", out.width='40%', echo=F }
...
```{r figure5, fig.cap="Figure 5. Partitioning the variance of X1", out.width='40%', echo=F }
...
```{r figure6, fig.cap="Figure 6. Ability bias", out.width='70%', echo=F }
...
```{r plot1, fig.cap="Figure 7. Relationship between Y and the omitted variable"}
...
Therefore, we can use the instrumental variable to partition the variance of education into a component that is highly correlated with ability (the residual), and a component that is uncorrelated with ability (X1-hat).  Remember the figure 5 we discussed at the beginning of the lecture:

```{r figure7, fig.cap="Figure 8. Instrumental variable model", out.width='40%', echo=F }
...
```{r plot2, fig.cap="Figure 9. Partitioning the variance of Education"}
...
```{r plot3, fig.cap="Figure 10. Relationship between the 'parts' of education and Y"}
...
```{r plot4, fig.cap="Figure 11. Correlation between Y and the omitted variable"}
...
```{r figure8, fig.cap="Figure 12. Instrumental variable model, path diagram", out.width='40%', echo=F }
...
```{r matrixstructure, fig.cap="Figure 13. Correlation matrix structure", echo=F, fig.height=10}
...
```{r plot5, fig.cap="Figure 14. Distribution of Y, X, and Z"}
par( mfrow=c(1,2) )
