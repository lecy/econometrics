...
```{r doppel, fig.cap="Figure 1. Doppelg?nger", out.width='80%', echo=F }
...
```{r exampleCover, fig.cap="Figure 2. Source: https://pixabay.com/images/search/classroom/", out.width='60%', echo=F }
