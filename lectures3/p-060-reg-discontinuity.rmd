...
```{r rd-intro1, fig.cap="Figure 1. Program participants score above the threshold", out.width='60%', echo=F }
...
```{r rd-intro2, fig.cap="Figure 2. Program participants score below the threshold", out.width='60%', echo=F }
...
```{r rdfigure, fig.cap="Figure 3. Students' family income and college enrollment", out.width='60%', echo=F }
...
```{r rdfigure2, fig.cap="Figure 4. Control and treatment group based on the cutoff", out.width='60%', echo=F }
...
```{r rdfigure3, fig.cap="Figure 5. Treatment effect", out.width='60%', echo=F }
...
```{r dataset, fig.cap="Figure 6. Regression discontinuity dataset", out.width='60%', echo=F }
...
```{r counterfactual, fig.cap="Figure 7. Counterfactual", out.width='60%', echo=F }
...
```{r housing, fig.cap="Figure 8. Source: https://www.pinterest.com/youthchange/classroom-posters-121-130/", out.width='40%', echo=F }
...
```{r Linear1, fig.cap = "Figure 9. Source: http://econ.lse.ac.uk/staff/spischke/mhe/ex_ch6.pdf",  out.width='80%', echo=F }
...
```{r Linear2, fig.cap = "Figure 10. Source: http://econ.lse.ac.uk/staff/spischke/mhe/ex_ch6.pdf",out.width='80%', echo=F }
...
```{r Linear3, fig.cap = "Figure 11. Source: http://econ.lse.ac.uk/staff/spischke/mhe/ex_ch6.pdf", out.width='80%', echo=F }
